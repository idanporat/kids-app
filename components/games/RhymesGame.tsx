      ...
      <div className="grid w-full max-w-lg grid-cols-1 gap-4 sm:grid-cols-3">
        {shuffledOptions.map((file) => (
          <button
            ...
            className="flex min-h-[104px] items-center justify-center rounded-3xl border-4 border-slate-200 bg-white p-2 shadow-md transition active:scale-95 disabled:opacity-70 dark:border-slate-600 dark:bg-slate-900"
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={twemojiUrl(file)}
